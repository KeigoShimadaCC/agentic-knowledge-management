...
def upgrade() -> None:
    ...
    op.create_index("uq_settings_secrets_user_key", "settings_secrets", ["user_id", "key"], unique=True)
    ...
    op.create_index("uq_prompt_overrides_user_prompt", "prompt_overrides", ["user_id", "prompt_key"], unique=True)
