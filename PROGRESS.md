...
- T6 verification: `make test-all` passed end to end after resetting the isolated `knowledgeos_test` database: frontend 27 tests, API/unit 134 tests with the existing Qdrant version warning, worker 18 tests, MCP 20 tests, and Playwright 10 tests.
